...
@Module({
  ...
  }), AcademiaModule, UsuarioModule, RolesUsuariosModule, Periodo, CursoModule, CursosAcademiasModule, InscripcionModule, EvaluacionModule, CertificadoModule, NotificacionModule,],
